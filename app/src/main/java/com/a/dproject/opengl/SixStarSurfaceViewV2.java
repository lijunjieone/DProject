...
public class SixStarSurfaceViewV2 extends GLSurfaceView
{
	...
	public SixStarSurfaceViewV2(Context context) {
        super(context);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            for(SixPointedStarV2 h:mRenderer.ha)
            {
    ...
    {
        SixPointedStarV2[] ha=new SixPointedStarV2[6];//六角星数组
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config) {
			...
			// 创建六角星数组中的各个对象
			for (int i = 0; i < ha.length; i++) {
				ha[i] = new SixPointedStarV2(SixStarSurfaceViewV2.this, 0.4f, 1.0f,-1.0f * i,color[i]);
			}			
