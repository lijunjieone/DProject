...
import static com.a.dproject.opengl.ShaderUtil.createProgram;

//六角星
public class SixPointedStarV2
{	
    ...
    public SixPointedStarV2(SixStarSurfaceViewV2 mv,float r,float R,float z,float[] color)
    {    	
 ...
 // 初始化顶点坐标数据的方法
   ...
   // 初始化着色器
    public void initShader(SixStarSurfaceViewV2 mv)
    {
    	//加载顶点着色器的脚本内容
