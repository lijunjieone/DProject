...
public class DrawTypeSurfaceView extends GLSurfaceView
{
    private SceneRenderer mRenderer;//场景渲染器
	public DrawTypeSurfaceView(Context context) {
        super(context);
    ...
    {   
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建点或线对象
            PointsOrLines=new PointsOrLines(DrawTypeSurfaceView.this);
            //打开深度检测
